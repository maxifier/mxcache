 ...
 */
public abstract class AbstractFloatCharacterCache extends AbstractCache implements FloatCharacterCache, FloatCharacterStorage {
    ...
    public AbstractFloatCharacterCache(Object owner, FloatCharacterCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
