 ...
 */
public abstract class AbstractBooleanShortCache extends AbstractCache implements BooleanShortCache, BooleanShortStorage {
    ...
    public AbstractBooleanShortCache(Object owner, BooleanShortCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
