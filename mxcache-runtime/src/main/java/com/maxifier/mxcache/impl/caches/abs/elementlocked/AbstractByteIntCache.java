 ...
 */
public abstract class AbstractByteIntCache extends AbstractElementLockedCache implements ByteIntCache, ByteIntElementLockedStorage {
    ...
    public AbstractByteIntCache(Object owner, ByteIntCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
