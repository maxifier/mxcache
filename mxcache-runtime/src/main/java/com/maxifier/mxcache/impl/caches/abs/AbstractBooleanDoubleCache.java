 ...
 */
public abstract class AbstractBooleanDoubleCache extends AbstractCache implements BooleanDoubleCache, BooleanDoubleStorage {
    ...
    public AbstractBooleanDoubleCache(Object owner, BooleanDoubleCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private double create(boolean o) {
