 ...
 */
public abstract class AbstractShortCharacterCache extends AbstractElementLockedCache implements ShortCharacterCache, ShortCharacterElementLockedStorage {
    ...
    public AbstractShortCharacterCache(Object owner, ShortCharacterCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
