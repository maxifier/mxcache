 ...
 */
public abstract class AbstractLongShortCache extends AbstractElementLockedCache implements LongShortCache, LongShortElementLockedStorage {
    ...
    public AbstractLongShortCache(Object owner, LongShortCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
