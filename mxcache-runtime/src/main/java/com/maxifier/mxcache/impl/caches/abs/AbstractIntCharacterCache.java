 ...
 */
public abstract class AbstractIntCharacterCache extends AbstractCache implements IntCharacterCache, IntCharacterStorage {
    ...
    public AbstractIntCharacterCache(Object owner, IntCharacterCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
