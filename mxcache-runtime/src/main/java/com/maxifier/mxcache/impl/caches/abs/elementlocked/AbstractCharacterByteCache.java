 ...
 */
public abstract class AbstractCharacterByteCache extends AbstractElementLockedCache implements CharacterByteCache, CharacterByteElementLockedStorage {
    ...
    public AbstractCharacterByteCache(Object owner, CharacterByteCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
