 ...
 */
public abstract class AbstractCharacterLongCache extends AbstractElementLockedCache implements CharacterLongCache, CharacterLongElementLockedStorage {
    ...
    public AbstractCharacterLongCache(Object owner, CharacterLongCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
