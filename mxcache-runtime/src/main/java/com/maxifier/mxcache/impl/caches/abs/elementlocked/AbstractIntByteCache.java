 ...
 */
public abstract class AbstractIntByteCache extends AbstractElementLockedCache implements IntByteCache, IntByteElementLockedStorage {
    ...
    public AbstractIntByteCache(Object owner, IntByteCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
