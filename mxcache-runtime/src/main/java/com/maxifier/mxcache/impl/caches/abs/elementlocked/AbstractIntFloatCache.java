 ...
 */
public abstract class AbstractIntFloatCache extends AbstractElementLockedCache implements IntFloatCache, IntFloatElementLockedStorage {
    ...
    public AbstractIntFloatCache(Object owner, IntFloatCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
