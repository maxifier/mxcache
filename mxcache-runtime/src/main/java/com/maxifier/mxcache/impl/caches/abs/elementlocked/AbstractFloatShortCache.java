 ...
 */
public abstract class AbstractFloatShortCache extends AbstractElementLockedCache implements FloatShortCache, FloatShortElementLockedStorage {
    ...
    public AbstractFloatShortCache(Object owner, FloatShortCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private short create(float key) {
