 ...
 */
public abstract class AbstractObjectFloatCache<E> extends AbstractCache implements ObjectFloatCache<E>, ObjectFloatStorage<E> {
    ...
    public AbstractObjectFloatCache(Object owner, ObjectFloatCalculatable<E> calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
