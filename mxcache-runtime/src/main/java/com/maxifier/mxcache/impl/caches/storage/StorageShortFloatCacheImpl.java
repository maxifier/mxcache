 ...
 */
public class StorageShortFloatCacheImpl extends AbstractShortFloatCache implements StorageHolder<ShortFloatStorage> {
    ...
    @Override
    public void setStorage(@NotNull ShortFloatStorage storage) {
