 ...
 */
public abstract class AbstractFloatByteCache extends AbstractElementLockedCache implements FloatByteCache, FloatByteElementLockedStorage {
    ...
    public AbstractFloatByteCache(Object owner, FloatByteCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
