 ...
 */
public abstract class AbstractByteShortCache extends AbstractElementLockedCache implements ByteShortCache, ByteShortElementLockedStorage {
    ...
    public AbstractByteShortCache(Object owner, ByteShortCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
