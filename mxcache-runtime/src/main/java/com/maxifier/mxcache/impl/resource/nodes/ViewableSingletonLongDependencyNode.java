...
/**
 * ViewableSingletonLongDependencyNode
 *
 * @author Elena Saymanina (elena.saymanina@maxifier.com) (29.05.13)
 */
public class ViewableSingletonLongDependencyNode extends SingletonDependencyNode implements ResourceViewable {
    private static final Logger logger = LoggerFactory.getLogger(ViewableSingletonLongDependencyNode.class);
    ...
    public boolean isChanged() {
        if (instance instanceof LongStorage && instance instanceof LongCache) {
            LongStorage storage = (LongStorage) instance;
