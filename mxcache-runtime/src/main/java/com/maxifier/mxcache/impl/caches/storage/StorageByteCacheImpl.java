...
public class StorageByteCacheImpl extends AbstractByteCache implements StorageHolder<ByteStorage> {
    ...
    public StorageByteCacheImpl(Object owner, ByteCalculatable calculatable, @NotNull MutableStatistics statistics) {
        super(owner, calculatable, statistics);
    }

    @Override
    public void setStorage(@NotNull ByteStorage storage) {
