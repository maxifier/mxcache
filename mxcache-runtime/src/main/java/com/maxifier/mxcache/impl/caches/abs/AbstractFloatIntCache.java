 ...
 */
public abstract class AbstractFloatIntCache extends AbstractCache implements FloatIntCache, FloatIntStorage {
    ...
    public AbstractFloatIntCache(Object owner, FloatIntCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
