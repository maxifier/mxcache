 ...
 */
public class StorageIntIntCacheImpl extends AbstractIntIntCache implements StorageHolder<IntIntStorage> {
    ...
    @Override
    public void setStorage(@Nonnull IntIntStorage storage) {
