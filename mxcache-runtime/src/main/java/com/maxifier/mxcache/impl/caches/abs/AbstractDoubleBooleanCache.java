 ...
 */
public abstract class AbstractDoubleBooleanCache extends AbstractCache implements DoubleBooleanCache, DoubleBooleanStorage {
    ...
    public AbstractDoubleBooleanCache(Object owner, DoubleBooleanCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private boolean create(double o) {
