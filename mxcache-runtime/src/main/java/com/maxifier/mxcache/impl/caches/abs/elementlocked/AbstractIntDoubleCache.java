 ...
 */
public abstract class AbstractIntDoubleCache extends AbstractElementLockedCache implements IntDoubleCache, IntDoubleElementLockedStorage {
    private final IntDoubleCalculatable calculatable;

    public AbstractIntDoubleCache(Object owner, IntDoubleCalculatable calculatable, MutableStatistics statistics) {
    ...
    protected double create(int key) {
