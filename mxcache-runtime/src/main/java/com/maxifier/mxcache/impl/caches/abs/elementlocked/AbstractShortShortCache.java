 ...
 */
public abstract class AbstractShortShortCache extends AbstractElementLockedCache implements ShortShortCache, ShortShortElementLockedStorage {
    ...
    public AbstractShortShortCache(Object owner, ShortShortCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private short create(short key) {
