 ...
 */
public abstract class AbstractFloatFloatCache extends AbstractElementLockedCache implements FloatFloatCache, FloatFloatElementLockedStorage {
    ...
    public AbstractFloatFloatCache(Object owner, FloatFloatCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private float create(float key) {
