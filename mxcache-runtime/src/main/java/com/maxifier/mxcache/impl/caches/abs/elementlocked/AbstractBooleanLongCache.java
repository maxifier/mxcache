...
public abstract class AbstractBooleanLongCache extends AbstractElementLockedCache implements BooleanLongCache, BooleanLongElementLockedStorage {
    ...
    public AbstractBooleanLongCache(Object owner, BooleanLongCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private long create(boolean key) {
