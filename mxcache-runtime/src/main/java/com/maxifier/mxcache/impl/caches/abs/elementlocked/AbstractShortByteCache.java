 ...
 */
public abstract class AbstractShortByteCache extends AbstractElementLockedCache implements ShortByteCache, ShortByteElementLockedStorage {
    ...
    public AbstractShortByteCache(Object owner, ShortByteCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
