 ...
 */
public class StorageDoubleByteCacheImpl extends AbstractDoubleByteCache implements StorageHolder<DoubleByteElementLockedStorage> {
    private DoubleByteElementLockedStorage storage;

    public StorageDoubleByteCacheImpl(Object owner, DoubleByteCalculatable calculatable, @Nonnull MutableStatistics statistics) {
        super(owner, calculatable, statistics);
    }

    @Override
    public void setStorage(@Nonnull DoubleByteElementLockedStorage storage) {
