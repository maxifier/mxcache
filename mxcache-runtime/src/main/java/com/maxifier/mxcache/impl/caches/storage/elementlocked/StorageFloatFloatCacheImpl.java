 ...
 */
public class StorageFloatFloatCacheImpl extends AbstractFloatFloatCache implements StorageHolder<FloatFloatElementLockedStorage> {
    private FloatFloatElementLockedStorage storage;

    public StorageFloatFloatCacheImpl(Object owner, FloatFloatCalculatable calculatable, @NotNull DependencyNode node, @NotNull MutableStatistics statistics) {
        super(owner, calculatable, node, statistics);
    }

    @Override
    public void setStorage(@NotNull FloatFloatElementLockedStorage storage) {
    ...
    @Override
    public float load(float key) {
        return storage.load(key);
    }

    @Override
    public void save(float key, float value) {
