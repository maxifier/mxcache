 ...
 */
public abstract class AbstractLongBooleanCache extends AbstractElementLockedCache implements LongBooleanCache, LongBooleanElementLockedStorage {
    ...
    public AbstractLongBooleanCache(Object owner, LongBooleanCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private boolean create(long key) {
