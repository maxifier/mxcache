 ...
 */
public abstract class AbstractFloatObjectCache<F> extends AbstractElementLockedCache implements FloatObjectCache<F>, FloatObjectElementLockedStorage<F> {
    ...
    public AbstractFloatObjectCache(Object owner, FloatObjectCalculatable<F> calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
