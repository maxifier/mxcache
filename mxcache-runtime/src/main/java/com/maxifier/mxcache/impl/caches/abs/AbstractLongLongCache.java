 ...
 */
public abstract class AbstractLongLongCache extends AbstractCache implements LongLongCache, LongLongStorage {
    ...
    public AbstractLongLongCache(Object owner, LongLongCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
