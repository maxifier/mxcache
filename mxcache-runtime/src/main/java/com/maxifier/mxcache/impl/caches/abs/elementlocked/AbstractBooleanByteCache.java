 ...
 */
public abstract class AbstractBooleanByteCache extends AbstractElementLockedCache implements BooleanByteCache, BooleanByteElementLockedStorage {
    ...
    public AbstractBooleanByteCache(Object owner, BooleanByteCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private byte create(boolean key) {
