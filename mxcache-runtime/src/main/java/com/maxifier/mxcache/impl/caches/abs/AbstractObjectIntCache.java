 ...
 */
public abstract class AbstractObjectIntCache<E> extends AbstractCache implements ObjectIntCache<E>, ObjectIntStorage<E> {
    ...
    public AbstractObjectIntCache(Object owner, ObjectIntCalculatable<E> calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
