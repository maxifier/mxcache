 ...
 */
public abstract class AbstractByteBooleanCache extends AbstractCache implements ByteBooleanCache, ByteBooleanStorage {
    ...
    public AbstractByteBooleanCache(Object owner, ByteBooleanCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
