 ...
 */
public abstract class AbstractFloatLongCache extends AbstractElementLockedCache implements FloatLongCache, FloatLongElementLockedStorage {
    ...
    public AbstractFloatLongCache(Object owner, FloatLongCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
