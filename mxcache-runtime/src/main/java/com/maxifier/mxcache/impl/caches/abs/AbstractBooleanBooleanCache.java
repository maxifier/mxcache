 ...
 */
public abstract class AbstractBooleanBooleanCache extends AbstractCache implements BooleanBooleanCache, BooleanBooleanStorage {
    ...
    public AbstractBooleanBooleanCache(Object owner, BooleanBooleanCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private boolean create(boolean o) {
