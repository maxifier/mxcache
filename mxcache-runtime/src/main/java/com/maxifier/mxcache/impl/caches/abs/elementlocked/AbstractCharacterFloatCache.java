 ...
 */
public abstract class AbstractCharacterFloatCache extends AbstractElementLockedCache implements CharacterFloatCache, CharacterFloatElementLockedStorage {
    ...
    public AbstractCharacterFloatCache(Object owner, CharacterFloatCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
