 ...
 */
public abstract class AbstractObjectDoubleCache<E> extends AbstractElementLockedCache implements ObjectDoubleCache<E>, ObjectDoubleElementLockedStorage<E> {
    ...
    public AbstractObjectDoubleCache(Object owner, ObjectDoubleCalculatable<E> calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
