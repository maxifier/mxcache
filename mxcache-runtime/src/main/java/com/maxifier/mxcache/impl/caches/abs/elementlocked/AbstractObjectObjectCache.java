 ...
 */
public abstract class AbstractObjectObjectCache<E, F> extends AbstractElementLockedCache implements ObjectObjectCache<E, F>, ObjectObjectElementLockedStorage<E, F> {
    ...
    public AbstractObjectObjectCache(Object owner, ObjectObjectCalculatable<E, F> calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
