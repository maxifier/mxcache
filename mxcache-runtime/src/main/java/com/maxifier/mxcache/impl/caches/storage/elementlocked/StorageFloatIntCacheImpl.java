 ...
 */
public class StorageFloatIntCacheImpl extends AbstractFloatIntCache implements StorageHolder<FloatIntElementLockedStorage> {
    private FloatIntElementLockedStorage storage;

    public StorageFloatIntCacheImpl(Object owner, FloatIntCalculatable calculatable, @Nonnull MutableStatistics statistics) {
        super(owner, calculatable, statistics);
    }

    @Override
    public void setStorage(@Nonnull FloatIntElementLockedStorage storage) {
    ...
    @Override
    public int load(float key) {
        return storage.load(key);
    }

    @Override
    public void save(float key, int value) {
