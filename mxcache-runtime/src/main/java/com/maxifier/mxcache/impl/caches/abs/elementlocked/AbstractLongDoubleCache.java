 ...
 */
public abstract class AbstractLongDoubleCache extends AbstractElementLockedCache implements LongDoubleCache, LongDoubleElementLockedStorage {
    ...
    public AbstractLongDoubleCache(Object owner, LongDoubleCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private double create(long key) {
