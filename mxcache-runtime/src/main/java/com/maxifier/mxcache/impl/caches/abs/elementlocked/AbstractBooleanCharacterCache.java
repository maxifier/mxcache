 ...
 */
public abstract class AbstractBooleanCharacterCache extends AbstractElementLockedCache implements BooleanCharacterCache, BooleanCharacterElementLockedStorage {
    ...
    public AbstractBooleanCharacterCache(Object owner, BooleanCharacterCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
