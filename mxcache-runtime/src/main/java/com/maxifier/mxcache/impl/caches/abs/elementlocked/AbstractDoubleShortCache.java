 ...
 */
public abstract class AbstractDoubleShortCache extends AbstractElementLockedCache implements DoubleShortCache, DoubleShortElementLockedStorage {
    ...
    public AbstractDoubleShortCache(Object owner, DoubleShortCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private short create(double key) {
