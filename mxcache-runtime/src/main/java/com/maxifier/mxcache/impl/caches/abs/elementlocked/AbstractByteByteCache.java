...
public abstract class AbstractByteByteCache extends AbstractElementLockedCache implements ByteByteCache, ByteByteElementLockedStorage {
    ...
    public AbstractByteByteCache(Object owner, ByteByteCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
