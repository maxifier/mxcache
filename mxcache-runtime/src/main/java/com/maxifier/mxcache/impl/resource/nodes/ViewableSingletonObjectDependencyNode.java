 ...
 */
public class ViewableSingletonObjectDependencyNode extends SingletonDependencyNode implements ResourceViewable {
    private static final Logger logger = LoggerFactory.getLogger(ViewableSingletonObjectDependencyNode.class);
    ...
    public boolean isChanged() {
        if (instance instanceof ObjectStorage && instance instanceof ObjectCache) {
