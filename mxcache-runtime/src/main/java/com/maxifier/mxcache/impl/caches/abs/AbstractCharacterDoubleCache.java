 ...
 */
public abstract class AbstractCharacterDoubleCache extends AbstractCache implements CharacterDoubleCache, CharacterDoubleStorage {
    ...
    public AbstractCharacterDoubleCache(Object owner, CharacterDoubleCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
