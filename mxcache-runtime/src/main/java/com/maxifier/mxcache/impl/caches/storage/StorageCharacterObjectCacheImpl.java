 ...
 */
public class StorageCharacterObjectCacheImpl<F> extends AbstractCharacterObjectCache<F> implements StorageHolder<CharacterObjectStorage<F>> {
    ...
    @Override
    public void setStorage(@NotNull CharacterObjectStorage<F> storage) {
