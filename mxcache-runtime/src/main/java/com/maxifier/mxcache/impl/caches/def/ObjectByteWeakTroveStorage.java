 ...
 */
public class ObjectByteWeakTroveStorage<T extends SmartReference> extends ObjectByteTroveStorage<T> {
    ...
    @Override
    public byte load(T o) {
        cleanup();
        return super.load(o);
    }

    @Override
    public void save(final T o, byte t) {
        cleanup();
