...
/**
 * StorageCharacterFloatCacheImpl
 *
 ...
 */
public class StorageCharacterFloatCacheImpl extends AbstractCharacterFloatCache implements StorageHolder<CharacterFloatStorage> {
    ...
    @Override
    public void setStorage(@Nonnull CharacterFloatStorage storage) {
