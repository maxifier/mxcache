 ...
 */
public class StorageDoubleCacheImpl extends AbstractDoubleCache implements StorageHolder<DoubleStorage> {
    ...
    @Override
    public void setStorage(@Nonnull DoubleStorage storage) {
