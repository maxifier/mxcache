...
public abstract class AbstractShortBooleanCache extends AbstractCache implements ShortBooleanCache, ShortBooleanStorage {
    ...
    public AbstractShortBooleanCache(Object owner, ShortBooleanCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
    ...
    private boolean create(short o) {
