 ...
 */
public abstract class AbstractLongFloatCache extends AbstractElementLockedCache implements LongFloatCache, LongFloatElementLockedStorage {
    ...
    protected float create(long key) {
