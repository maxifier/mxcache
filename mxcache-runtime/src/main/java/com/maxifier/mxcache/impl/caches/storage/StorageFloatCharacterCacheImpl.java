...
/**
 * StorageFloatCharacterCacheImpl
 *
 ...
 */
public class StorageFloatCharacterCacheImpl extends AbstractFloatCharacterCache implements StorageHolder<FloatCharacterStorage> {
    private static final long serialVersionUID = 100L;

    private FloatCharacterStorage storage;
    ...
    @Override
    public void setStorage(@Nonnull FloatCharacterStorage storage) {
    ...
    @Override
    public char load(float key) {
        return storage.load(key);
    }

    @Override
    public void save(float key, char value) {
