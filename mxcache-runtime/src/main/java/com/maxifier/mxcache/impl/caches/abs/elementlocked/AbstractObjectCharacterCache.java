 ...
 */
public abstract class AbstractObjectCharacterCache<E> extends AbstractElementLockedCache implements ObjectCharacterCache<E>, ObjectCharacterElementLockedStorage<E> {
    ...
    public AbstractObjectCharacterCache(Object owner, ObjectCharacterCalculatable<E> calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
