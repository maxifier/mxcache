 ...
 */
public abstract class AbstractIntCache extends AbstractCache implements IntCache, IntStorage {
    ...
    public AbstractIntCache(Object owner, IntCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
