 ...
 */
public abstract class AbstractIntLongCache extends AbstractElementLockedCache implements IntLongCache, IntLongElementLockedStorage {
    ...
    public AbstractIntLongCache(Object owner, IntLongCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
