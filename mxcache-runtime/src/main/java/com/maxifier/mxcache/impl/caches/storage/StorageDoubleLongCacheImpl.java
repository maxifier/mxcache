 ...
 */
public class StorageDoubleLongCacheImpl extends AbstractDoubleLongCache implements StorageHolder<DoubleLongStorage> {
    ...
    @Override
    public void setStorage(@Nonnull DoubleLongStorage storage) {
