 ...
 */
public abstract class AbstractByteDoubleCache extends AbstractCache implements ByteDoubleCache, ByteDoubleStorage {
    ...
    public AbstractByteDoubleCache(Object owner, ByteDoubleCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
