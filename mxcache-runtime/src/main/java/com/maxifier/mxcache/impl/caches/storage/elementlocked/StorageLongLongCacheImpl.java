 ...
 */
public class StorageLongLongCacheImpl extends AbstractLongLongCache implements StorageHolder<LongLongElementLockedStorage> {
    private LongLongElementLockedStorage storage;

    public StorageLongLongCacheImpl(Object owner, LongLongCalculatable calculatable, @NotNull DependencyNode node, @NotNull MutableStatistics statistics) {
        super(owner, calculatable, node, statistics);
    }

    @Override
    public void setStorage(@NotNull LongLongElementLockedStorage storage) {
    ...
    @Override
    public void save(long key, long value) {
