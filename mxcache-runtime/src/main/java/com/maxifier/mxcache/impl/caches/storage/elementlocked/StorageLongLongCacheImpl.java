...
public class StorageLongLongCacheImpl extends AbstractLongLongCache implements StorageHolder<LongLongElementLockedStorage> {
    ...
    public StorageLongLongCacheImpl(Object owner, LongLongCalculatable calculatable, @Nonnull MutableStatistics statistics) {
        super(owner, calculatable, statistics);
    }

    @Override
    public void setStorage(@Nonnull LongLongElementLockedStorage storage) {
