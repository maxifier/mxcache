...
public class StorageBooleanCacheImpl extends AbstractBooleanCache implements StorageHolder<BooleanElementLockedStorage> {
    ...
    public StorageBooleanCacheImpl(Object owner, BooleanCalculatable calculatable, @NotNull DependencyNode node, @NotNull MutableStatistics statistics) {
        super(owner, calculatable, node, statistics);
    }

    @Override
    public void setStorage(@NotNull BooleanElementLockedStorage storage) {
