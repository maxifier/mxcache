...
public abstract class AbstractLongObjectCache<F> extends AbstractElementLockedCache implements LongObjectCache<F>, LongObjectElementLockedStorage<F> {
    ...
    public AbstractLongObjectCache(Object owner, LongObjectCalculatable<F> calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
