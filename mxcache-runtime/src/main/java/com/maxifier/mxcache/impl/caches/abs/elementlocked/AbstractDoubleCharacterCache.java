 ...
 */
public abstract class AbstractDoubleCharacterCache extends AbstractElementLockedCache implements DoubleCharacterCache, DoubleCharacterElementLockedStorage {
    ...
    public AbstractDoubleCharacterCache(Object owner, DoubleCharacterCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
