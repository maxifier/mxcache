 ...
 */
public abstract class AbstractCharacterBooleanCache extends AbstractCache implements CharacterBooleanCache, CharacterBooleanStorage {
    ...
    public AbstractCharacterBooleanCache(Object owner, CharacterBooleanCalculatable calculatable, @NotNull DependencyNode node, MutableStatistics statistics) {
        super(statistics);
        this.node = node;
        this.owner = owner;
