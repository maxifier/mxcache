 ...
 * Time: 15:04:56
 * <p>
 * Ётот класс необходимо расшир€ть, если вы хотите сделать поддержку собственных аннотаций дл€ указани€ стратегии
 * хэшировани€. ƒл€ этого перекройте метод {@link AbstractHashingStrategyFactory#findStrategyClass(com.maxifier.mxcache.context.CacheContext, Class, java.lang.annotation.Annotation[])}.
 */
public abstract class AbstractHashingStrategyFactory implements HashingStrategyFactory {
    ...
    /**
     * Ётот метод должен создавать подход€шую стратегию хэшировани€.
     * @param context context of instance
     * @param paramType тип параметра, который должен сравниватьс€
     * @param annotations аннотации параметра, среди которых необходимо найти аннотацию
     * @return стратегию хэшировани€, или null, если стратеги€ не найдена; рекоммендуетс€ возвратить null и вывести
     * сообщение в лог, если указана неправильна€ аннотаци€ или класс стратегии.
     */
