...
public abstract class AnnotationProperty<A extends Annotation, T> extends StrategyProperty<T> {
    ...
    /**
     * „итает значение настройки из аннотации.
     * ¬ызываетс€, если у метода есть подход€ща€ не перекрыта€ аннотаци€.
     * @param annotation аннотаци€
     * @return значени свойства из аннотации; null означает, что должно использоватьс€ значени, указанное ранее
     * (в xml конфигурации)
     */
