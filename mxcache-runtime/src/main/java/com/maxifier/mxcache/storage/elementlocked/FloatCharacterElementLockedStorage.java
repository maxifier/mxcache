...
/**
 * FloatCharacterElementLockedStorage
 *
 ...
 */
public interface FloatCharacterElementLockedStorage extends FloatCharacterStorage, ElementLockedStorage {
    void lock(float key);

    void unlock(float key);
}