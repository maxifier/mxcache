 ...
 */
@Test
public class FloatFloatCacheBoxKeyTest {
    ...
    public void testMiss() {
        ...
        FloatFloatCache cache = (FloatFloatCache) Wrapping.getFactory(new Signature(Object.class, float.class), new Signature(float.class, float.class), false).
