 ...
 */
@Test
public class ByteByteCacheBoxKeyValueTest {
    ...
    public void testMiss() {
        ...
        ByteByteCache cache = (ByteByteCache) Wrapping.getFactory(new Signature(Object.class, Object.class), new Signature(byte.class, byte.class), false).
