 ...
 */
@Test
public class BooleanLongCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        BooleanLongCache cache = (BooleanLongCache) Wrapping.getFactory(new Signature(boolean.class, Object.class), new Signature(boolean.class, long.class), false).
