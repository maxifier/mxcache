 ...
 */
@Test
public class LongIntCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        LongIntCache cache = (LongIntCache) Wrapping.getFactory(new Signature(long.class, Object.class), new Signature(long.class, int.class), false).
