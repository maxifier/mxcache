 ...
 */
@Test
public class ByteIntCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        ByteIntCache cache = (ByteIntCache) Wrapping.getFactory(new Signature(byte.class, Object.class), new Signature(byte.class, int.class), false).
