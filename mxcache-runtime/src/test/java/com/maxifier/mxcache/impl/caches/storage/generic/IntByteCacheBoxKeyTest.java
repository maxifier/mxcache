 ...
 */
@Test
public class IntByteCacheBoxKeyTest {
    ...
    public void testMiss() {
        ...
        IntByteCache cache = (IntByteCache) Wrapping.getFactory(new Signature(Object.class, byte.class), new Signature(int.class, byte.class), false).
