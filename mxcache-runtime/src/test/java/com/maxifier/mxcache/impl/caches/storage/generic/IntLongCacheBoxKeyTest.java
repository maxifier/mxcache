 ...
 */
@Test
public class IntLongCacheBoxKeyTest {
    ...
    public void testMiss() {
        ...
        IntLongCache cache = (IntLongCache) Wrapping.getFactory(new Signature(Object.class, long.class), new Signature(int.class, long.class), false).
