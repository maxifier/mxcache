 ...
 */
@Test
public class IntBooleanCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        IntBooleanCache cache = (IntBooleanCache) Wrapping.getFactory(new Signature(int.class, Object.class), new Signature(int.class, boolean.class), false).
