 ...
 */
@Test
public class ShortIntCacheBoxKeyTest {
    ...
    public void testMiss() {
        ...
        ShortIntCache cache = (ShortIntCache) Wrapping.getFactory(new Signature(Object.class, int.class), new Signature(short.class, int.class), false).
