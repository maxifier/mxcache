 ...
 */
@Test
public class LongByteCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        LongByteCache cache = (LongByteCache) Wrapping.getFactory(new Signature(long.class, Object.class), new Signature(long.class, byte.class), false).
