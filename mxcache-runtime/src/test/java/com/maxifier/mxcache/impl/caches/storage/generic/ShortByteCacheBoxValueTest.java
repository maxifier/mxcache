 ...
 */
@Test
public class ShortByteCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        ShortByteCache cache = (ShortByteCache) Wrapping.getFactory(new Signature(short.class, Object.class), new Signature(short.class, byte.class), false).
