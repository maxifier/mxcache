 ...
 */
@Test
public class ByteDoubleCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        ByteDoubleCache cache = (ByteDoubleCache) Wrapping.getFactory(new Signature(byte.class, Object.class), new Signature(byte.class, double.class), false).
