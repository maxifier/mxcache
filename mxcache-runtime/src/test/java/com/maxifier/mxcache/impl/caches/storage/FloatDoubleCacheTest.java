...
import com.maxifier.mxcache.storage.elementlocked.FloatDoubleElementLockedStorage;
...
public class FloatDoubleCacheTest {
    private static final Signature SIGNATURE = new Signature(float.class, double.class);
    ...
    private static class Occupied implements FloatDoubleCalculatable {
        ...
        @Override
        public synchronized double calculate(Object owner, float o) {
            if (occupied) {
                occupiedRequests++;
                notifyAll();
    ...
    public void testOccupied(boolean elementLocked) throws Throwable {
        ...
        if (elementLocked) {
                ...
                ((FloatDoubleElementLockedStorage)verify(storage, atLeast(1))).lock(42f);
                ((FloatDoubleElementLockedStorage)verify(storage, atLeast(1))).unlock(42f);
    ...
    private FloatDoubleStorage createStorage(boolean elementLocked) {
        // cast necessary for JDK8 compilation
        FloatDoubleStorage storage = mock((Class<FloatDoubleStorage>)(elementLocked ? FloatDoubleElementLockedStorage.class : FloatDoubleStorage.class));
        if (elementLocked) {
            when(((FloatDoubleElementLockedStorage)storage).getLock()).thenReturn(new ReentrantLock());
        }
        return storage;
    }    
    ...
    public void testTransparentStat(boolean elementLocked) {
        // cast necessary for JDK8 compilation
        FloatDoubleStorage storage = mock((Class<FloatDoubleStorage>)(elementLocked ? FloatDoubleElementLockedStorage.class : FloatDoubleStorage.class), withSettings().extraInterfaces(StatisticsHolder.class));
