 ...
 */
@Test
public class ShortIntCacheBoxKeyValueTest {
    ...
    public void testMiss() {
        ...
        ShortIntCache cache = (ShortIntCache) Wrapping.getFactory(new Signature(Object.class, Object.class), new Signature(short.class, int.class), false).
