 ...
 */
@Test
public class IntLongCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        IntLongCache cache = (IntLongCache) Wrapping.getFactory(new Signature(int.class, Object.class), new Signature(int.class, long.class), false).
