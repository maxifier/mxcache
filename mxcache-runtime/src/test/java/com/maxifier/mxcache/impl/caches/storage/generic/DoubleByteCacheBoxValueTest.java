 ...
 */
@Test
public class DoubleByteCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        DoubleByteCache cache = (DoubleByteCache) Wrapping.getFactory(new Signature(double.class, Object.class), new Signature(double.class, byte.class), false).
