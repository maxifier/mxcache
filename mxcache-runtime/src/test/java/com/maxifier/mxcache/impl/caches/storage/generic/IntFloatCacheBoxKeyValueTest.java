 ...
 */
@Test
public class IntFloatCacheBoxKeyValueTest {
    ...
    public void testMiss() {
        ...
        IntFloatCache cache = (IntFloatCache) Wrapping.getFactory(new Signature(Object.class, Object.class), new Signature(int.class, float.class), false).
