 ...
 */
@Test
public class FloatIntCacheBoxKeyTest {
    ...
    public void testMiss() {
        ...
        FloatIntCache cache = (FloatIntCache) Wrapping.getFactory(new Signature(Object.class, int.class), new Signature(float.class, int.class), false).
