 ...
 */
@Test
public class FloatByteCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        FloatByteCache cache = (FloatByteCache) Wrapping.getFactory(new Signature(float.class, Object.class), new Signature(float.class, byte.class), false).
    ...
    public void testSetDuringDependencyNodeOperations() {
        ...
        when(storage.load(42f)).thenReturn(Storage.UNDEFINED, (byte)42);
