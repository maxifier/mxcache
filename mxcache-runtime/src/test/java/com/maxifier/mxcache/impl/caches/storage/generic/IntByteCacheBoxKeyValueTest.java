 ...
 */
@Test
public class IntByteCacheBoxKeyValueTest {
    ...
    public void testMiss() {
        ...
        IntByteCache cache = (IntByteCache) Wrapping.getFactory(new Signature(Object.class, Object.class), new Signature(int.class, byte.class), false).
