 ...
 */
@Test
public class LongFloatCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        LongFloatCache cache = (LongFloatCache) Wrapping.getFactory(new Signature(long.class, Object.class), new Signature(long.class, float.class), false).
