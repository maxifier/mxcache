 ...
 */
@Test
public class DoubleIntCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        DoubleIntCache cache = (DoubleIntCache) Wrapping.getFactory(new Signature(double.class, Object.class), new Signature(double.class, int.class), false).
