 ...
 */
@Test
public class ShortLongCacheBoxValueTest {
    ...
    public void testMiss() {
        ...
        ShortLongCache cache = (ShortLongCache) Wrapping.getFactory(new Signature(short.class, Object.class), new Signature(short.class, long.class), false).
